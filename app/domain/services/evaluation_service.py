...
from app.domain.math.calculate_ingredient_overlap import calculate_ingredient_overlap
...
class EvaluationService:
    ...
    def create_evaluation(self, uuid: UUID):
        ...
        ingredient_overlap = calculate_ingredient_overlap(generated_recipe.ingredients, original_recipe.ingredients)
